        ...
        <div className="container align-items-center mt-5">
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.goodreads.com/book/show/57538.It_s_All_in_Your_Head?ac=1&from_search=true&qid=K8qlukoVRY&rank=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/stMj7L8.jpg"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/vK4WTTl.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.goodreads.com/book/show/6398634-the-happiness-project?ac=1&from_search=true&qid=xzqg6scRvC&rank=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/fg0kGEd.jpg"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.whyislam.org/spiritual-journeys/happiness/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/FuGR1lj.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 ">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/xMst2vY.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://yaqeeninstitute.org/omar-edward-moad/the-technology-of-happiness/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/eDIzhsj.png"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://gretchenrubin.com/books/better-than-before/about-the-book/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/LO8IKvt.jpg"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.psychologytoday.com/us/blog/click-here-happiness/201801/how-be-happy-23-ways-be-happier"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/pGZCUO5.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://gretchenrubin.com/books/the-four-tendencies/intro/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/FQE1o51.jpg"
          ...
          <div className="row">
            <div className="col-12  col-sm-12 col-mb-4 col-lg-4  mb-4">
              <div className="card border border-white rounded">
                <Iframe
                  url="https://www.youtube.com/embed/_R6R62qUgIs"
                  className="rounded card-img-top img-fluid"
                />
              </div>
            </div>
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/wJCUAvd.png"
            ...
            <div className="col-12  col-sm-12 col-mb-4 col-lg-4  mb-4">
              <div className="card border border-white rounded">
                <Iframe
                  url="https://www.youtube.com/embed/pIhUUs28dj0"
                  className="rounded card-img-top img-fluid"
                />
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/Qq6DtHz.png"
            ...
            <div className="col-12  col-sm-12 col-mb-4 col-lg-4  mb-4">
              <div className="card border border-white rounded">
                <Iframe
                  url="https://www.youtube.com/embed/GXy__kBVq1M"
                  className="rounded card-img-top img-fluid"
                />
              </div>
            </div>
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/SNPvEiB.png"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card  border border-white rounded">
                <Iframe
                  url="https://www.youtube.com/embed/g3SO3Ej2G6E"
                  className="rounded card-img-top img-fluid"
                />
              </div>
            </div>
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.goodreads.com/book/show/43822448-chicken-soup-for-the-soul?ac=1&from_search=true&qid=e9CMxuPt1H&rank=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/4GVQSqX.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card  border border-white rounded">
                <Iframe
                  url="https://www.youtube.com/embed/q42CHm2-tYw"
                  className="rounded card-img-top img-fluid"
                />
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/Ud2txvh.jpg"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://greatergood.berkeley.edu/podcasts/series/the_science_of_happiness"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/nfbhiQh.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/AA6GdK2.png"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/NpgJpNn.png"
                  alt="If you want other to be happy, practise compassion. If you want to be happy, practise happy."
                  className="rounded card-img-top img-fluid"
                />
              </div>
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/7YmLNQw.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <a
                  href="https://www.goodreads.com/book/show/2326098.The_How_of_Happiness?ac=1&from_search=true&qid=EAA3atyhgb&rank=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/iAqm8ku.jpg"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/aNEMuAp.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                <img
                  src="https://i.imgur.com/DuJpjHP.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4">
              <div className="card border border-white rounded">
                <a
                  href="https://www.goodreads.com/book/show/22571656-the-happiness-equation"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/A2uHFxd.png"
          ...
          <div className="row">
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card border border-white rounded">
                ...
                >
                  <img
                    src="https://i.imgur.com/87UAQhP.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4">
              <div className="card img-fluid border border-white rounded">
                <img
                  src="https://i.imgur.com/Xl15xs5.png"
            ...
            <div className="col-12 col-sm-12 col-mb-4 col-lg-4 col-xl-4 mb-4 Big">
              <div className="card img-fluid border border-white rounded">
                <a
                  href="https://gretchenrubin.com/podcasts/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    src="https://i.imgur.com/xbx95Oa.png"
